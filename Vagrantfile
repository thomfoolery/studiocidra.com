Vagrant.configure("2") do |config|
  ...
  config.vm.define :local do |box|
    box.vm.hostname = "local.studiocidra.com"

    # Static IP for testing.
    box.vm.network :private_network, ip: "192.168.251.130"
    box.vm.network :forwarded_port, guest: 22, host: 5113, auto_correct: true
    ...
    # Provision local.studiocidra.com
